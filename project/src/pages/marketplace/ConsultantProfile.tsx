  ...
  return (
    <div className="min-h-screen bg-[#f8fafc] pb-32">
      ...
      <div className="relative">
        <div className="h-[320px] w-full relative overflow-hidden bg-[#0c2438]">
          ...
          <div className="absolute top-8 left-8 z-10">
            <button
              onClick={onBack}
              className="flex items-center gap-3 px-6 py-3 bg-white/10 backdrop-blur-xl rounded-2xl text-white font-black text-xs uppercase tracking-widest hover:bg-white/20 transition-all border border-white/20"
            >
        ...
        <div className="max-w-[1400px] mx-auto px-6 md:px-12 relative -mt-32 z-10">
          <div className="bg-white rounded-[3rem] shadow-2xl shadow-slate-900/10 p-10 md:p-12 flex flex-col md:flex-row gap-10 items-start md:items-center border border-white">
            <div className="relative">
              <div className="w-32 h-32 md:w-48 md:h-48 bg-white rounded-[3rem] border-[8px] border-white shadow-2xl overflow-hidden shrink-0">
      ...
      <div className="max-w-[1400px] mx-auto px-6 md:px-12 mt-20">
        {/* Navigation Tabs */}
        <div className="flex flex-wrap gap-12 border-b-2 border-slate-100 mb-16">
          {[
            ...
            <button
              ...
              className={`pb-6 px-2 text-sm font-black transition-all relative uppercase tracking-widest ${
                activeTab === tab.id
                  ? "text-blue-600"
        ...
        <div className="space-y-24">
          {activeTab === "recorded" && (
            <div className="animate-in fade-in slide-in-from-bottom-5 duration-700">
              <div className="mb-12">
                <h2 className="text-3xl font-black text-slate-900 italic tracking-tight">Recorded Sessions</h2>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10">
                  {courses.map((course) => (
                    <div 
                      ...
                      className="bg-white rounded-[3rem] border border-slate-100 overflow-hidden shadow-2xl shadow-slate-100/50 hover:shadow-blue-600/10 transition-all group cursor-pointer flex flex-col h-full"
                    >
                      ...
                      <div className="p-10 flex-1 flex flex-col">
                        ...
                        <h4 className="font-black text-slate-900 mb-4 text-2xl leading-tight italic tracking-tight uppercase">{course.title}</h4>
          ...
          {activeTab === "paid" && (
            <div className="animate-in fade-in slide-in-from-bottom-5 duration-700">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
                {/* 1-1 Call Card */}
                <div className="bg-[#0c2438] rounded-[3.5rem] overflow-hidden group shadow-2xl transition-all duration-500 hover:-translate-y-2 flex flex-col">
                   <div className="p-10 bg-gradient-to-r from-blue-900 to-[#1a3a5a] text-center space-y-2">
                      ...
                      <h3 className="text-3xl font-black text-white italic tracking-tight uppercase">Private Video Call</h3>
                   ...
                   <div className="p-10 flex-1 flex flex-col justify-center gap-6">
                      {[
                        ...
                        <button 
                          ...
                          className="w-full bg-white/5 p-8 rounded-[2rem] hover:bg-blue-600 transition-all group/btn flex items-center justify-between border border-white/5 active:scale-95"
                        >
                           <div className="flex items-center gap-4">
                             <div className="w-12 h-12 bg-white/5 rounded-2xl flex items-center justify-center text-blue-400">
                                <Clock className="w-6 h-6" />
                             </div>
                             <span className="text-xl font-black text-white italic tracking-tight">{pkg.time} MINS</span>
                           </div>
                           <p className="text-3xl font-black text-white tracking-tighter">$ {pkg.price.toFixed(0)}</p>
                        </button>
                      ))}
                   </div>
                </div>
                ...
                {/* 1-1 Chat Card */}
                <div className="bg-[#0c2438] rounded-[3.5rem] overflow-hidden group shadow-2xl transition-all duration-500 hover:-translate-y-2 flex flex-col">
                   <div className="p-10 bg-gradient-to-r from-indigo-900 to-[#1e1b4b] text-center space-y-2">
                      ...
                      <h3 className="text-3xl font-black text-white italic tracking-tight uppercase">Unlimited Chat</h3>
                      <p className="text-indigo-200/50 font-bold text-xs uppercase tracking-widest">Direct Messaging Access</p>
                   </div>
                   <div className="p-12 flex-1 flex flex-col items-center justify-center text-center space-y-10">
                      ...
                      <button 
                        ...
                        className="w-full py-8 bg-blue-600 hover:bg-blue-700 text-white font-black rounded-[2.5rem] text-2xl shadow-2xl shadow-blue-900/40 transition-all flex items-center justify-center gap-4 active:scale-95"
                      >
          ...
          {activeTab === "reviews" && (
            <div className="animate-in fade-in slide-in-from-bottom-5 duration-700">
               <div className="flex flex-col md:flex-row md:items-center justify-between gap-8 mb-16">
                <div>
                  <h2 className="text-3xl font-black text-slate-900 italic tracking-tight">Success Stories</h2>
                  <p className="text-slate-400 font-medium">What the community has to say about their mentoring experience.</p>
                </div>
                <div className="flex items-center gap-4">
                  <button 
                    onClick={() => setShowReviewModal(true)}
                    className="px-10 py-5 bg-blue-600 text-white font-black rounded-2xl hover:bg-blue-700 transition-all shadow-2xl shadow-blue-600/30 text-xs uppercase tracking-widest"
                  >
                    Post a Review
                  </button>
                </div>
              ...
              {reviews.length > 0 ? (
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10">
                  {reviews.map((review: any) => (
                    <div key={review.id} className="bg-white p-10 rounded-[3rem] border border-slate-100 shadow-2xl shadow-slate-100/50 hover:border-blue-100 transition-all flex flex-col">
        ...
        {similarMentors.length > 0 && (
          <div className="mt-40 mb-20 border-t-2 border-slate-50 pt-32 animate-in fade-in slide-in-from-bottom-5 duration-1000">
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-8 mb-16">
               <div>
                 <h2 className="text-4xl font-black text-slate-900 italic tracking-tighter uppercase">Related Creators</h2>
                 <p className="text-slate-400 font-medium">Unlock more expert guidance from our community of professionals.</p>
               </div>
               <button className="px-10 py-5 bg-white text-slate-900 font-black rounded-2xl border-2 border-slate-100 hover:border-blue-600 hover:text-blue-600 transition-all shadow-sm text-xs uppercase tracking-widest">
                  View Directory
               </button>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
               {similarMentors.map((mentor) => (
                 <div 
                   key={mentor.user_id}
                   className="bg-white p-10 rounded-[3rem] border border-slate-100 shadow-2xl shadow-slate-100/50 hover:shadow-blue-600/10 transition-all group overflow-hidden relative"
                 >
                    <div className="relative z-10 text-center space-y-6">
                       ...
                       <button className="w-full py-4 bg-slate-50 text-slate-900 font-black rounded-2xl text-[10px] uppercase tracking-widest hover:bg-blue-600 hover:text-white transition-all">
                          See Portfolio
                       </button>
                    </div>
                 </div>
      ...
      {selectedCourse && (
        <div className="fixed inset-0 z-[60] flex items-center justify-center p-6 bg-[#0c2438]/80 backdrop-blur-xl animate-in fade-in duration-300">
           <div className="bg-white w-full max-w-5xl rounded-[4rem] overflow-hidden shadow-2xl flex flex-col md:row animate-in zoom-in-95 duration-500">
              ...
              <div className="md:w-1/2 p-10 md:p-16 relative flex flex-col justify-center">
                 <button 
                 ...
                 <div className="space-y-10">
                    ...
                    <div className="flex items-center justify-between gap-10 pt-10">
                       ...
                       <button className="flex-1 h-20 bg-blue-600 hover:bg-blue-700 text-white font-black rounded-[2rem] shadow-2xl shadow-blue-600/30 transition-all flex items-center justify-center gap-3 active:scale-95 group">
                          Unlock Access
